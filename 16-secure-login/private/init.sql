-- We're going to manually create a table to store the login information to an admin account. We could also do this with a text file in the data/ folder on our server.
